...
class CommentServiceImplTest {
    ...
    void editById() {
        // given
        when(commentRepository.getById(14L))
                .thenReturn(new Comment().setId(14L).setCommentText("oldText"));
        ...
        // then
        verify(commentRepository, times(1)).update(new Comment()
                .setId(14L)
    ...
    void addByBookId() {
        // given
        when(bookRepository.getById(13L))
                .thenReturn(new Book().setId(13L));
        when(userCommunicator.getAnswer("Write comment please:"))
                .thenReturn("newText");
        ...
        // then
        verify(commentRepository, times(1)).insert(new Comment()
                .setCommentText("newText")
